...
//   @override
//   _NoteDetailState createState() => _NoteDetailState(appbartitle);
// }

// class _NoteDetailState extends State<NoteDetail> {
//   String appbartitle;
//   var prio = ["low", 'medium', 'high'];
//   var selected = 'low';
...
//     return WillPopScope(
//         onWillPop: () {
//           movetolastscreen(); /*control the phone back button*/
//         },
//         child: Scaffold(
//             appBar: AppBar(
...
//                 onPressed: movetolastscreen, /* control the icon */
//               ),
//             ),
//             body: ListView(
//               children: <Widget>[
...
//                       items: prio.map((String dropdownitem) {
